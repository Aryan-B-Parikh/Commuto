...
export default function VerifyOTPPage() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center px-4 bg-[#0B1020]">
            <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                className="w-full max-w-md"
            >
                <div className="bg-[#111827] rounded-3xl border border-[#1E293B] shadow-xl shadow-black/30 p-6 lg:p-8 text-center">
                    {/* Logo */}
                    ...
                    <AnimatePresence mode="wait">
                        {!isVerified ? (
                            ...
                            >
                                ...
                                <h1 className="text-2xl font-bold text-[#F9FAFB] mb-2">Verify your email</h1>
                                ...
                                <form onSubmit={handleSubmit} className="space-y-6">
                                    ...
                                    <div className="text-sm text-[#6B7280]">
                                        {seconds > 0 ? (
                                            <p>
                                                Code expires in <span className="font-medium text-[#F9FAFB]">{formattedTime}</span>
                                            </p>
                                        ) : (
                            ...
                            >
                                ...
                                <h2 className="text-2xl font-bold text-[#F9FAFB] mb-2">Verified!</h2>
