    ...
    useEffect(() => {
        const fetchActiveTrip = async () => {
            try {
                ...
                // Fetch the passenger's active trip
        ...
        return (
            <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
                <Card className="text-center py-12">
                    ...
                    <p className="text-gray-500 mb-6">You don't have an active trip at the moment.</p>
                    <Button onClick={() => router.push('/passenger/dashboard')}>Go to Dashboard</Button>
                </Card>
            </div>
        );
    }
